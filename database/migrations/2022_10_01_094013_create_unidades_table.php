...
class CreateUnidadesTable extends Migration
{
    ...
    {
        //A reversão tem de ser feita no sentido oposto à criação
        //remover a chave estrangeira e coluna na tabela produto_detalhes
        Schema::table('produto_detalhes', function (Blueprint $table) {
            //remover a FK
        ...
        //remover a chave estrangeira e coluna na tabela produtos
        Schema::table('produtos', function (Blueprint $table) {
            //remover a FK
